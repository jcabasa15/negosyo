...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
      ...
      <form method='post' action='' enctype="multipart/form-data">
        <div class="container">
        <h5 class="pull-left">
            Add New Product &nbsp&nbsp
            <small>
            <a href="products.php" class="product">
              <i class="fa fa-arrow-circle-left"></i>
              <span>Go back to the Products List</span>
            </a>
          </small>
        </h5>
        <div class="pull-right">
          <button class="btn btn-primary btn-sm ml-3 mt-3.5" onclick="location.href='#'">Save</button>
          <button class="btn btn-primary btn-sm ml-3 mt-3.5" onclick="location.href='#'">Save and Continue Edit</button>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <input type="textarea" class="form-control" id="exampleInputName1"  placeholder="Enter Product Name">
          <small class="form-text text-muted">Please Enter your new Product here</small>
        </div>
        <div class="form-group">
            <label for="exampleInputCategory1">Category</label>
            <select class="form-control valid" data-val="true" data-val-required="The Category field is required." id="SearchCategoryId" name="SearchCategoryId">
        ...
        <div class="form-group">
          <label for="exampleInputeditor1">Description</label>
          <textarea name="editor1"></textarea>
        </div>
        <div class="form-group">
           <label for="exampleInputPrice1">Price</label>
           <input type="text" data-val="true" data-val-required="The field Price must be a number." id="Price" name="Price" value="0.00" class="form-control valid" style="display: block">
        </div>
        <div class="form-group">
            <label for="producttag">Product Tag</label>
            <input type="text" data-val="true" id="ptag" name="ptag" class="form-control valid" placeholder="Enter your best Product Tag">
        </div>
        <div class="form-group">
            <label for="qty">Quantity</label>
            <input type="text" data-val="true" data-val-required="Numbers Only" id="qty" name="qty" class="form-control valid" placeholder="Quantity of your Product">
        </div>
         <div form-group>
