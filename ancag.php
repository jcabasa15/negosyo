...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
      ...
      <div class="container">
        <h5 class="pull-left">
            Add New Category &nbsp&nbsp
            <small>
            <a href="categories.php" class="category">
              <i class="fa fa-arrow-circle-left"></i> 
              <span>Go back to the Category's List</span>
            </a>
          </small>
        </h5>
      ...
      <div class="container col-md-6">
        <div class="form-group">
          ...
          <input type="textarea" class="form-control" id="exampleInputName1"  placeholder="Enter Category Name">
          <small class="form-text text-muted">Please Enter your new Category here</small>
        </div>
        <div class="form-group">
