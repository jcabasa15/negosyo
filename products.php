  ...
  <div class="content-wrapper">
    ...
    <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>&nbsp Products</div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody role="rowgroups">
                <tr>
                  ...
                  <td>PHP 6,000</td>
                  <td>Edi wow</td>
                  <td style="text-align:center" role="gridcell  "><button class="btn btn-secondary ml-3 mt-3.5" onclick="location.href='#'"> <i class="fa fa-pencil"></i> &nbsp Edit</button></td>  
                </tr>
              </tbody>
              </table>
      </div>
       <button class="btn btn-primary ml-3 mt-3.5" onclick="location.href='anproduct.php'">Add New</button>
    </div>
    </div>
